import 'package:e_shop/models/api_response.dart';
import 'package:e_shop/utility/snack_bar_helper.dart';
...
class UserProvider extends ChangeNotifier {
  ...
  Future<String?> login(LoginData data) async {
    try {
      ...
      SnackBarHelper.showErrorSnackBar('An error occur $e');
    }
  }
